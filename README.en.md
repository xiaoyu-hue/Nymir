...
| [qrcode](https://www.npmjs.com/package/qrcode) | MIT | QR code generation (SVG output, v1.6.1) |
| [jsqr](https://github.com/cozmo/jsQR) | Apache-2.0 | QR code camera scanning (v1.6.1) |
...
| [husky](https://typicode.github.io/husky/) | MIT | Git hooks management (pre-commit gate) |
| [@types/qrcode](https://www.npmjs.com/package/@types/qrcode) | MIT | QR code type declarations (v1.6.1) |
